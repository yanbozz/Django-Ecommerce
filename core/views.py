...
class CheckoutView(View):
    ...
    def get(self, *arg, **kwargs):
        try:
            ...
            messages.info(self.request, "You do not have an activer order.")
            return redirect("core:checkout")

    def post(self, *arg, **kwargss):
...
class PaymentView(View):
    def get(self, *args, **kwargs):
        ...
        if order.billing_address:
            ...
            messages.warning(self.request, "Please fill your billing information first.")
            return redirect("core:checkout")
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            # yourself an email
            messages.warning(
                self.request, "Something went wrong. You were not charged. Pleas try agian.")
            return redirect("/")
